 ...
 *>    DEBUG_YSTR   yLOG_value   ("n"         , n);                                       <* 
 *>    /+---(return)-------------------------+/                                           <* 
 *>    if (a_title   != NULL)  ystrlcpy (a_title  , ystr_langs [l].host   , LEN_LABEL);   <* 
 *>    if (a_content != NULL)  ystrlcpy (a_content, ystr_hosts [n]        , LEN_LABEL);   <* 
 *>    /+---(complete)-----------------------+/                                           <* 
 *>    DEBUG_YSTR   yLOG_sexitr  (__FUNCTION__, rce);                                     <* 
 *>    return n;                                                                          <* 
 *> }                                                                                     <*/
 ...
 *>    DEBUG_YSTR   yLOG_value   ("n"         , n);                                       <* 
 *>    /+---(return)-------------------------+/                                           <* 
 *>    if (a_title   != NULL)  ystrlcpy (a_title  , ystr_langs [l].cluster, LEN_LABEL);   <* 
 *>    if (a_content != NULL)  ystrlcpy (a_content, ystr_clusters [n]     , LEN_LABEL);   <* 
 *>    /+---(complete)-----------------------+/                                           <* 
 *>    DEBUG_YSTR   yLOG_sexitr  (__FUNCTION__, rce);                                     <* 
 *>    return n;                                                                          <* 
 *> }                                                                                     <*/
